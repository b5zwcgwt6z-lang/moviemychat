    ...
    <div className="card py-10 group">
      <Link to={`/movie/${item.id}`}>
        <div className="aspect-2/3 relative overflow-hidden rounded-md">
          <img className="object-cover w-full h-full transition-transform duration-300 group-hover:opacity-110" src={poster} alt={item.title} />
        ...
        <div className="flex flex-col px-1">
          ...
          <span className="flex items-center gap-2 font-bold text-yellow-500">
            ...
            <span className="font-light">{item.release_date}</span>
          </span>
        </div>
      </Link>
    </div>
